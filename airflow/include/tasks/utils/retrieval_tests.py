...
def weaviate_qna(weaviate_client:WeaviateClient, question:str, class_name:str) -> pd.Series:
    ...
    try:
        results = weaviate_client.query.get(class_name=class_name, 
                                            properties=[
                                                "docLink", 
        ...
        answers = [result['_additional']['answer']['result'] for result in results]
        answers = '\n-----\n'.join(answers)
...
def generate_crc(weaviate_client:WeaviateClient, question:str, class_name:str, ts_nodash:str) -> pd.Series:
    """
